...
<body class="bg-white text-black">
  ...
  <nav x-data="{ open: false }" class="fixed bg-white top-0 left-0 w-full shadow px-6 py-1 z-50">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:flex flex-1 items-center mx-6 space-x-6">
        <input
          type="text"
          placeholder="Search..."
          class="w-full text text-sm h-7 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400">
        <a href="#" class="bg-orange-500 h-7 text-white px-4 py-2 rounded hover:bg-orange-600 text-sm flex items-center">Ask</a>
...
<?php if (isset($_SESSION['user_id'])): ?>
    ...
    <a href="/User/profile.php" class="hover:text-orange-500">
      <?php if (empty($profileImage)): ?>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A9.953 9.953 0 0112 15c2.15 0 4.145.676 5.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
      <?php else: ?>
  ...
  <?php if (isset($_SESSION['user_id'])): ?>
      <a href="../User/profile.php" class="flex items-center text-gray-700 hover:text-orange-500 space-x-2"> 
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
  </svg>
      <span class="text-gray-700 hover:text-orange-500">Profile</span>
  </a>
  <?php else: ?>
