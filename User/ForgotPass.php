          ...
          $mail->Body = "
                    ...
                    <head>
                      <style>
                        ...
                        .btn { display: inline-block; padding: 12px 24px; margin-top: 20px; background-color: #f97316; border-radius: 6px; font-weight: bold; text-decoration: none;}
                    ...
                    <body>
                      <div class='email-container'>
                        ...
                        <a href='$reset_link' class='btn' style='color: #fff;'>Reset Your Password</a>
