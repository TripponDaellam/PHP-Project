...
<body class="bg-gray-50 text-black pt-20">
  ...
  <div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <!-- Left Sidebar (only on md and above) -->
    ...
    dropdowns.forEach(d => {
      if (!d.parentElement.contains(e.target)) {
        d.classList.add('hidden');
              ...
              <!-- Title -->
              <a href="/question/<?= $q['id'] ?>" class="text-xl font-semibold text-orange-600 hover:underline block">
  ...
  <form method="POST" action="vote.php">
    ...
    <aside class="hidden lg:block w-72 px-4 py-6 bg-gray-100 rounded shadow ml-auto mt-20 mr-6 h-fit sticky top-24">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        arsort($allTags);
        $popularTags = array_slice($allTags, 0, 12, true);
