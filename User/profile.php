  ...
  <div class="flex flex-nowrap md:flex-wrap justify-start md:justify-center space-x-4 mt-4 border-b w-full px-4">
    ...
    <div id="info" class="tab-content active bg-white shadow rounded-xl p-6 space-y-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-red-50 p-4 rounded-md border">
        <div><p class="text-sm text-gray-500">Full Name</p><p class="font-medium text-gray-800"><?= htmlspecialchars($user['full_name'] ?? 'N/A') ?></p></div>
        <div><p class="text-sm text-gray-500">Username</p><p class="font-medium text-gray-800"><?= htmlspecialchars($user['username']) ?></p></div>
        <div><p class="text-sm text-gray-500">Email</p><p class="font-medium text-gray-800"><?= htmlspecialchars($user['email']) ?></p></div>
        <div><p class="text-sm text-gray-500">Phone</p><p class="font-medium text-gray-800"><?= htmlspecialchars($user['phone'] ?? 'N/A') ?></p></div>
        <div><p class="text-sm text-gray-500">Password</p><p class="font-medium text-gray-800">************</p></div>
      </div>
    ...
    <div id="links" class="tab-content bg-white shadow rounded-xl p-6 space-y-4">
      ...
      <div><p class="text-sm text-gray-500">Website</p><p class="font-medium text-blue-600 underline"><?= htmlspecialchars($user['website'] ?? 'N/A') ?></p></div>
      <div><p class="text-sm text-gray-500">GitHub</p><p class="font-medium text-blue-600 underline"><?= htmlspecialchars($user['github'] ?? 'N/A') ?></p></div>
    </div>
