...
<body class="bg-gray-50 text-black">
  ...
  <div class="max-w-3xl mx-auto p-6">
    <h1 class="text-2xl top-10 font-bold mb-6">Ask a New Question</h1>

    <form action="post_question.php" method="POST" class="space-y-4">
      <div>
        <label class="block text-sm font-medium">Title</label>
        <br><label class="block text-sm font-small">Be specific and imagine you’re asking a question to another person</label></br>
